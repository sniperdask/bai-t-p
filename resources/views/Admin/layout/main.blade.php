...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{url('')}}/Admins/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{url('')}}/Admins/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  ...
  <!--[if lt IE 9]>
  <script src="{{url('')}}/Admins/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="{{url('')}}/Admins/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
